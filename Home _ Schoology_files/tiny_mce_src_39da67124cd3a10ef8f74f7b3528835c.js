	...
	tinymce.create('tinymce.Editor', {
		...
		render : function(nst) {
			...
			function loadScripts() {
              ...
              if (p === 'generatePassage') {
                var generatePassagePluginURL = (typeof Drupal.settings.s_tinymce != 'undefined' && typeof Drupal.settings.s_tinymce.generatePassagePluginURL != 'undefined') ? Drupal.settings.s_tinymce.generatePassagePluginURL : false;
                if (generatePassagePluginURL) {
                  PluginManager.load(p, generatePassagePluginURL);
                }
                return;
              }
