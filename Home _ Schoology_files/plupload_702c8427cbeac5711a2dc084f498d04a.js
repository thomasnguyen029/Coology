...
plupload.addFileFilter('max_file_size', function(maxSize, file, cb) {
	...
	if (file.size !== undef && maxSize && file.size > maxSize) {
		this.trigger('Error', {
			...
			message : sgyModules.Utils.i18n.t('core.file_size_error'),
			file : file
		});
		cb(false);
	} else {
...
plupload.Uploader = function(options) {
	...
	plupload.extend(this, {
		 ...
		 * @method start
		 */
		start : function(triggerNext) {
      triggerNext = typeof triggerNext !== 'undefined' ? triggerNext : true;
			if (this.state != plupload.STARTED) {
		 ...
		 */
		removeFile : function(file, triggerNext) {
      triggerNext = typeof triggerNext !== 'undefined' ? triggerNext : true;
			var id = typeof(file) === 'string' ? file : file.id;

			for (var i = files.length - 1; i >= 0; i--) {
				if (files[i].id === id) {
					return this.splice(i, 1, triggerNext)[0];
				}
			}
		},
		 ...
		 */
		splice : function(start, length, triggerNext) {
      triggerNext = typeof triggerNext !== 'undefined' ? triggerNext : true;
